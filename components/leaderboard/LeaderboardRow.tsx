...
export const LeaderboardRow: React.FC<LeaderboardRowProps> = ({ player, rank, isMe }) => {
    ...
    const REGION_DISPLAY_MAP: Record<string, string> = {
        ...
        'BR1': 'BR', 'LA1': 'LAN', 'OC1': 'OCE', 'TR1': 'TR', 'RU': 'RU', 'JP1': 'JP',
    };
    ...
    return (
        ...
        >
            <RankCell rank={rank} isTop3={isTop3} rankColor={rankColor} />
            <SummonerCell player={player} displayRegion={displayRegion} isTop3={isTop3} rankColor={rankColor} isMe={isMe} />
            <TierCell player={player} />
            <WinrateCell player={player} />
            <TopChampionsCell champions={player.topChampions} />
...
const RankCell = ({ rank, isTop3, rankColor }: { rank: number; isTop3: boolean; rankColor: string }) => (
...
const SummonerCell = ({ player, displayRegion, isTop3, rankColor, isMe }: any) => (
    <td className="p-4">
...
const TierCell = ({ player }: { player: LeaderboardEntry }) => (
    <td className="p-4">
...
const WinrateCell = ({ player }: { player: LeaderboardEntry }) => (
    <td className="p-4">
...
const TopChampionsCell = ({ champions }: { champions?: any[] }) => (
    <td className="p-4">
